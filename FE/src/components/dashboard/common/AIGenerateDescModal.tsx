...
interface AIGenerateDescModalProps {
  open: boolean;
  onClose: () => void;
  onGenerate: (opts: { tone: string; language: string; userNotes: string }) => void;
...
export function AIGenerateDescModal({
  open,
  onClose,
  onGenerate,
  isGenerating,
