...
func (c *RouteConfig) SetupAuthRoute() {
	...
	c.App.Get("/api/achievements", c.AchievementController.List)
	...
	c.App.Post("/api/skills/_bulk", c.SkillController.BulkCreate)
	c.App.Post("/api/skills", c.SkillController.Create)
	c.App.Put("/api/skills/:skillId", c.SkillController.Update)
	c.App.Delete("/api/skills/_bulk", c.SkillController.BulkDelete)
